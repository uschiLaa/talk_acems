...
- An alternative approach is the **slice tour**, discussed by Di last year [Laa, Cook, Valencia (2020)]
...
- We can also think of new transformation and slicing methods, for example a local transformation that takes density into account
