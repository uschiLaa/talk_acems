...
- To impose rotation invariance and avoide edge effects, we start from a hypersphere in p dimensions
...
- We introduced a new display that is useful when visualising high-dimensional data in low-dimensional projections
...
- These new displays are complementary to non-linear dimension reduction methods for visualisation, e.g. t-SNE
